# Awesome Digital Health [![Awesome Lists](https://srv-cdn.himpfen.io/badges/awesome-lists/awesomelists-flat.svg)](https://github.com/brandonhimpfen/awesome-lists)

[![DOI](https://zenodo.org/badge/1195442201.svg)](https://doi.org/10.5281/zenodo.19673268) <br />
...
> A curated list of platforms, tools, standards, and resources for modern digital health systems, healthcare innovation, and patient-centered technology.

_Support ongoing maintenance and curation via [GitHub Sponsors](https://github.com/sponsors/brandonhimpfen)._

## Contents

- [Clinical Systems & EHR](#clinical-systems--ehr)
...
- [Telemedicine & Virtual Care](#telemedicine--virtual-care)
- [Wearables & Remote Monitoring](#wearables--remote-monitoring)

## Clinical Systems & EHR

Core systems for managing patient records, clinical workflows, and healthcare operations.
...
Standards and frameworks that enable healthcare systems to exchange and understand data.
...
Tools and platforms for analyzing healthcare data, improving outcomes, and supporting decision-making.
...
AI systems and frameworks for diagnostics, imaging, prediction, and clinical decision support.
...
Platforms and datasets supporting epidemiology, research, and population health.
...
Platforms and tools enabling remote consultations and virtual healthcare delivery.
...
- Awesome Health Data & Interoperability — Standards, APIs, and systems for exchanging healthcare data.
